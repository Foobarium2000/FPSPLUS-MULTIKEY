...
class KeyBindMenuNine extends MusicBeatState
{

    var keyTextDisplay:FlxText;
    var keyWarning:FlxText;
    var warningTween:FlxTween;
    var keyText:Array<String> = ["LEFT1", "DOWN1", "UP1", "RIGHT1", "CENTER", "LEFT2", "DOWN2", "UP2", "RIGHT2"];
    var defaultKeys:Array<String> = ["A", "S", "D", "F", "SPACE", "H", "J", "K", "L", "R"];
    var curSelected:Int = 0;

    var keys:Array<String> = [FlxG.save.data.B1Bind,
                              FlxG.save.data.B2Bind,
                              FlxG.save.data.B3Bind,
                              FlxG.save.data.B4Bind,
                              FlxG.save.data.B5Bind,
                              FlxG.save.data.B6Bind,
                              FlxG.save.data.B7Bind,
                              FlxG.save.data.B8Bind,
                              FlxG.save.data.B9Bind,
    ...
    function textUpdate(){
        ...
        for(i in 0...keys.length){
            ...
            if(i < 9)
                ...
                keyTextDisplay.text += "RESET: " + keys[9]  + "\n";
    ...
    function save(){
        ...
        FlxG.save.data.B1Bind = keys[0]; // 0
        FlxG.save.data.B2Bind = keys[1]; // 2
        FlxG.save.data.B3Bind = keys[2]; // 2
        FlxG.save.data.B4Bind = keys[3]; // 3 
        FlxG.save.data.B5Bind = keys[4]; // 1
        FlxG.save.data.B6Bind = keys[5]; // 5
        FlxG.save.data.B7Bind = keys[6]; // 6
        FlxG.save.data.B8Bind = keys[7]; // 7
        FlxG.save.data.B9Bind = keys[8]; // 8
        FlxG.save.data.killBind = keys[9];
